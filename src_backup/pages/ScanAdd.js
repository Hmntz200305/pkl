...
const ScanAdd = () => {
  const {  openSidebar, setOpenSidebar, setNotification, setNotificationStatus, setNotificationInfo } = useAuth();
 ...
 useEffect(() => {
  ...
  const handleScan = async (scanData) => {
    ...
    if (scanData && scanData !== "") {
      try {
        const parsedResult = JSON.parse(scanData);
        if (
          parsedResult &&
          parsedResult['AssetID'] &&
          parsedResult['AssetName'] &&
          parsedResult['AssetDesc'] &&
          parsedResult['AssetBrand'] &&
          parsedResult['AssetModel'] &&
          parsedResult['AssetStatus'] &&
          parsedResult['AssetLocation'] &&
          parsedResult['AssetCategory'] &&
          parsedResult['AssetSN']
        ) {
          ...
          setNotificationInfo('success');
          setLoadingScan(false);
        } else {
          setNotification('Data QR tidak sesuai kriteria.');
          setNotificationStatus(true);
