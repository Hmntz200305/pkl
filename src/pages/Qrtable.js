...
const QRScanner = () => {
    ...
    const {token, DataListAssetExcept, refreshAssetDataExcept, LocationOptions, refreshLocationList, refreshAdminList, AdminList, username, setNotification, setNotificationInfo, setNotificationStatus } = useAuth();
        ...
        <>
            <div className='p-2'>
                <div className='bg-white mb-5 rounded-2xl p-4 shadow'>
                    <h2 className='text-xl font-semibold'>QRTable</h2>
                </div>
            </div>
